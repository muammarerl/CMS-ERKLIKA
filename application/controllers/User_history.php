...
use models\Chart_model;
class User_history extends CI_Controller {
	
		var $utama ='user_history';
		var $title ='User Log History';
	...
	function main()
	{
		...
		$data['user_history'] = $this->Chart_model->getLogUserHistory();

		$day = $this->input->get('day') ?: date('d');
        $month = $this->input->get('month') ?: date('m');
        $year = $this->input->get('year') ?: date('Y');

		$data['total_data_hari'] = $this->Chart_model->countDataThisToday();
		$data['total_data_bulan'] = $this->Chart_model->countDataThisMonth();
		$data['total_data_tahun'] = $this->Chart_model->countDataThisYears();
