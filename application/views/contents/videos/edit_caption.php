     ...
     <div class="col-12 mt-5">
      <div class="card">
       <div class="card-body">
    	...
    	<div class="box-content">
       <form method="post" id="formupload" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/submit_caption">
...
function uploadFile() {
  ...
  ajax.open("POST", "<?php echo base_url()?>videos/upload_caption/<?php echo $lang?>"); 
