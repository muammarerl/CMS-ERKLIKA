     ...
     <div class="col-12 mt-5">
      <div class="card">
       ...
       <form method="post" id="formupload" enctype="multipart/form-data" action="<?php echo base_url($this->utama)?>/submit_poster">
            ...
            <?php if(!empty($val['poster_'.$lang])){?>
            <div class="form-group">
            
                        <label for="<?php echo $nm_f?>">Current Poster : </label>
                        <div class="col-md-6"> <img src="<?php echo base_url().'assets/upload_poster/'.$val['poster_'.$lang]?>"/></div>
...
function uploadFile() {
  ...
  ajax.open("POST", "<?php echo base_url()?>videos/upload_poster/<?php echo $lang?>"); 
