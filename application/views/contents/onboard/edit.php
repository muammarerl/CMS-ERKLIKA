   ...
   <div class="row">
          ...
          <div class="tab-content">
           ...
           <div class="form-group">
            ...
            <?php $nm_f="content_id";?>
                        ...
                        <?php echo form_textarea($nm_f,(isset($val[$nm_f]) ? $val[$nm_f] : ''),'class="form-control" id="content_id"')?>
    ...
    <div id="en" class="tab-pane fade">
          ...
          <div class="form-group">
            ...
            <?php $nm_f="filez_id";?>
                        <label for="<?php echo $nm_f?>">Image (format JPG/PNG, 1244px × 1017px) <?php if(!empty($val['id'])) echo "*( Kosongkan bila tidak ingin mengganti Image"?></label>
                        <input type="file" name="<?php echo $nm_f?>"  id="<?php echo $nm_f?>" value="<?php echo (isset($val[$nm_f]) ? $val[$nm_f] : '') ?>" class="form-control"   onchange="showPreview(event);">
            ...
            <div class="current_img">
              ...
              <div class="row">
                <div class="col-md-4">
                <img id="file-ip-1-preview_en" style="max-width:100%" src="<?php echo "https://erklika.id:9024/assets/upload_onboard/".$val['image']?>">
                </div>
              </div>
              </div><?php } ?>
